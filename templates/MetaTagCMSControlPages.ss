		...
		<table summary="update metatag overview" id="root">
			<thead>
				<tr>
					...
					<th scope="col" class="auto" title="Update Meta and Menu Titles and Descriptions automatically?"><img src="/metatags_advanced/images/linked_horizontal_flip.png" alt="linked" title="This image identifies which fields are linked to the Page Title." class="right" />Apply Rules?</th>
					<th scope="col" class="menu" title="A shorter version of the Page Title, used in menus with limited room."><% if AlwaysUpdateMenuTitle %><img src="/metatags_advanced/images/linked.png" alt="linked" title="Menu Title automatically updates to Page Title (linked)" /><% end_if %>Menu Title</th>
					<% if SeparateMetaTitle %><th scope="col" class="metaT" title="The Page Title as it is 'seen' by search engines. It should be around seven words long and the words should reflect the keywords on the page."><% if AlwaysUpdateMetaTitle %><img src="/metatags_advanced/images/linked.png" alt="linked" title="Meta Title (or search engine title) automatically updates to Page Title (linked)" /><% end_if %>Meta Title</th><% end_if %>
					<th scope="col" class="metaD" title="The Page Description as shown on Search Engine result pages.  This should be one to three sentences describing the page.  Keep it simple and avoid things like: 'on this page'.  Example: All the contact details for the "><% if AlwaysUpdateMetaDescription %><img src="/metatags_advanced/images/linked.png" alt="linked" title="Meta Description (or search engine description) uses page content if no content has been entered" /><% end_if %>Meta Description</th>
				</tr>
			</thead>
			<tfoot>
				<tr class="actions">
					...
					<th scope="col" class="title" title="This is the key field - start by getting the Page Titles right and the rest will follow.">Page Title</th>
					<th scope="col" class="auto" title="Update Meta and Menu Titles and Descriptions automatically?"><img src="/metatags_advanced/images/linked_horizontal_flip.png" alt="linked" title="This image identifies which fields are linked to the Page Title." class="right" />Apply rules?</th>
					<th scope="col" class="menu" title="A shorter version of the Page Title, used in menus with limited room."><% if AlwaysUpdateMenuDescription %><img src="/metatags_advanced/images/linked.png" alt="linked" title="Menu Title automatically updates to Page Title (linked)" /><% end_if %>Menu Title</th>
					<% if SeparateMetaTitle %><th scope="col" class="metaT" title="The Page Title as it is 'seen' by search engines."><% if AlwaysUpdateMetaTitle %><img src="/metatags_advanced/images/linked.png" alt="linked" title="Meta  Title automatically updates to Page Title (linked)" /><% end_if %>Search Engine Title</th><% end_if %>
					<th scope="col" class="metaD" title="The Page Description as shown on Search Engine result pages."><% if AlwaysUpdateMetaDescription %><img src="/metatags_advanced/images/linked.png" alt="linked" title="Meta Description uses page content if no content has been entered" /><% end_if %>Search Engine Description</th>
				</tr>
